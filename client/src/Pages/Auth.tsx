...
export function Auth() {
	return (
		<div className="flex" style={{width: '100vw', height: '100vh'}}>
			<div className="page" style={{width: '50%', height: '100%'}}>
				<h1 className="">Welcome to Super App! 👋</h1>
				<section className="social">
					Sign in with:
					<div className="social-btn-group flex">
						<button>
				...
				{/*TODO: move to component and registration component*/}
				<form>
			...
			<div className="auth-image" style={{
				width: '50%', height: '100%',
				background: `url('${process.env.PUBLIC_URL}/images/auth-bg.jpg')`
			}}></div>
		</div>
	);
}
